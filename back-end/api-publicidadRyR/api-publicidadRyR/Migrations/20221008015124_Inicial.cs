    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    dni_cli = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    nombre_cli = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cliente", x => x.dni_cli);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_prod = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dni_cli1 = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Venta", x => x.codigo_venta);
                    table.ForeignKey(
                        name: "FK_Venta_Cliente_dni_cli1",
                        column: x => x.dni_cli1,
                        principalTable: "Cliente",
                        principalColumn: "dni_cli",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_prod1 = table.Column<string>(type: "nvarchar(450)", nullable: false),
